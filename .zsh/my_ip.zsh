...
if (( $+commands[lynx] )); then
    ...
    alias myip="curl -s -m 8 https://ipinfo.io/ip || curl -s -m 8 eth0.me || curl -s -m 5 ifconfig.me || curl -s -m 5 icanhazip.com || $WWWDUMP http://www.getip.com | sed -n 's/^Current IP: //p'"
else
