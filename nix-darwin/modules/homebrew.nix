...
}:
{
  ...
  homebrew = {
    ...
    brews = [
      ...
      "media-info" # MediaInfo CLI; the mediainfo cask below is the GUI
    ...
    casks = [
      ...
      # is also an alias of the media-info formula above, so that command
      # resolves the cask token to the formula too, leaving MediaInfo.app
      # absent.
      #
      ...
      # nix-homebrew pins brew 6.0.22, so drop this entry's args for a plain
